...
const HomeBusRoute: React.FC = () => {
  ...
  const fetchBusData = (query: string, setData: React.Dispatch<React.SetStateAction<string>>) => {
    fetch('https://api.entur.io/journey-planner/v3/graphql', {
      ...
      .then((stopPlaceData) => {
        ...
        setPublicCode2(parseInt(stopPlaceData.data.trip.tripPatterns[0].legs[2].line.publicCode));
        ...
        const expectedStartTime2 = new Date(stopPlaceData.data.trip.tripPatterns[0].legs[2].expectedStartTime);
  ...
  return (
    <View style={styles.container}>
      <Section title="From Oslo to Home" code={publicCode} time={busTime} />
      <Section title="From Oslo to Home" code={publicCode2} time={busTime2} />
    </View>
  );
};
